...
<body>
  ...
  <div class="card-body">
    ...
    <p class="card-text">If paid hourly, please follow this<a href="income_set_income_hourly.jsp" class="text-info"> link</a>.</p>
    <form action="SetIncomeServlet" method="POST">
    	<div class="form-group">
    		<input class="form-control" type="text" name="income" id="income" placeholder="Enter annual income">
    	</div>
